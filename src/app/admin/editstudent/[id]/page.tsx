...
type StudentField = {
  ...
  type: string;
  placeholder: string;
  editable?: boolean; // New property to mark editable fields
};

const STUDENT_FIELDS: StudentField[] = [
  { name: "name", label: "Full Name", type: "text", placeholder: "Enter full name", editable: true },
  { name: "email", label: "Email", type: "email", placeholder: "Enter email", editable: true },
  { name: "dob", label: "Date of Birth", type: "date", placeholder: "Select date of birth", editable: true },
  { name: "gender", label: "Gender", type: "text", placeholder: "Enter gender", editable: true },
  { name: "mobile_number", label: "Mobile Number", type: "text", placeholder: "Enter mobile number", editable: true },
  { name: "father_number", label: "Father's Number", type: "text", placeholder: "Enter father's number", editable: true },
  { name: "father_occupation", label: "Father's Occupation", type: "text", placeholder: "Enter father's occupation", editable: true },
  { name: "address", label: "Current Address", type: "text", placeholder: "Enter current address", editable: true },
  { name: "permanent_address", label: "Permanent Address", type: "text", placeholder: "Enter permanent address", editable: true },
  { name: "city", label: "City", type: "text", placeholder: "Enter city", editable: true },
  { name: "state", label: "State", type: "text", placeholder: "Enter state", editable: true },
  { name: "profession", label: "Profession", type: "text", placeholder: "Enter profession", editable: true },
  { name: "study_field", label: "Field of Study", type: "text", placeholder: "Enter field of study", editable: true },
  { name: "hobby", label: "Hobby", type: "text", placeholder: "Enter hobby", editable: true },
  { name: "interest", label: "Interest", type: "text", placeholder: "Enter interest", editable: true },
  { name: "skill", label: "Skill", type: "text", placeholder: "Enter skill", editable: true },
  { name: "group_name", label: "Group Name", type: "text", placeholder: "Enter group name", editable: false }, // Disabled
  { name: "chanting_round", label: "Chanting Rounds", type: "number", placeholder: "Enter chanting rounds", editable: true },
  { name: "sankalp_camp", label: "Sankalp Camp", type: "number", placeholder: "Enter sankalp camp count", editable: true },
  { name: "class_mode", label: "Class Mode", type: "text", placeholder: "Enter class mode", editable: false }, // Disabled
  { name: "payment_mode", label: "Payment Mode", type: "text", placeholder: "Enter payment mode", editable: false }, // Disabled
  { name: "payment_amount", label: "Payment Amount", type: "text", placeholder: "Enter payment amount", editable: false }, // Disabled
  { name: "student_status", label: "Student Status", type: "text", placeholder: "Enter student status", editable: false }, // Disabled
  { name: "frontliner_name", label: "Frontliner Name", type: "text", placeholder: "Enter frontliner name", editable: true },
  { name: "rating", label: "Rating", type: "number", placeholder: "Enter rating", editable: true },
  { name: "remark", label: "Remark", type: "text", placeholder: "Enter remark", editable: true },
  { name: "comment", label: "Comment", type: "text", placeholder: "Enter comment", editable: true },
];
    ...
    return (
      <div key={field.name} className="space-y-1">
        ...
        <input
          ...
          placeholder={field.placeholder}
          value={displayValue || ""}
          onChange={(e) => field.editable && handleChange(
            field.name,
            field.type === "number" ? parseInt(e.target.value) || null : e.target.value || null
          )}
